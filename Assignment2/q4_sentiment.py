...
### YOUR CODE HERE
REGULARIZATION = [0.5 ** x for x in range(10,16)]
### END YOUR CODE
...
### YOUR CODE HERE
best_params = sorted(results, key=itemgetter('dev'), reverse=True)
BEST_REGULARIZATION = best_params[0]["reg"]
BEST_WEIGHTS = best_params[0]["weights"]
### END YOUR CODE
